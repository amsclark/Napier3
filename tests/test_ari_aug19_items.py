...
def unruled_page(statute, description):
    """AMCR000000's shape, which no other fixture here has.
...
class TestParoleViolationsAgreeWithEachOther:
    """00000 AMCR000000, AMCR000000 and AMCR000000 against AMCR000000,
    AMCR000000 and AMCR000000. Same statute, same court, same client."""
...
class TestArrestWithoutWarrant:
    """00000 AMCR000000. No adjudication on the count, DISMISSED on the
